...
$text_panel_admin_login_template = "🤖 | PanelHub Bot
💎 | Version Bot: $version";
...
⚠️ تیم پنل‌هاب هیچ تضمینی برای درگاه ها نخواهد داشت و استفاده  و تمامی مسئولیت ها به عهده شما می باشد", $Bot_Status, 'HTML');
...
⚠️ تیم پنل‌هاب هیچ تضمینی برای درگاه ها نخواهد داشت و استفاده  و تمامی مسئولیت ها به عهده شما می باشد", $Bot_Status);
